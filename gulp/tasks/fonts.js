...
//   return data.pipe(app.gulp.dest(`src/`));
// };
...
//       .pipe(app.gulp.dest(`${app.path.buildFolder}/fonts/*.woff`))
//       // Ищем файлы шрифтов .ttf
...
//       .pipe(ttf2woff2())
//       // Выгружаем в папку с результатом
//       .pipe(app.gulp.dest(`${app.path.buildFolder}/fonts/*.woff2`))
//   );
// };
